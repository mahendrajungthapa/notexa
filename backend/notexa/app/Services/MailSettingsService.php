...
class MailSettingsService
{
    public static function apply(): void
    {
        ...
        $encryption = strtolower(trim((string) SiteSetting::get('smtp_encryption', 'tls')));
        ...
        Config::set('mail.mailers.smtp.auto_tls', $encryption === '' || $encryption === 'tls' || $encryption === 'starttls');
